...
const FAQ_ITEMS = [
  ...
  { question: "How many players do you need?", answer: "Liar's Dice is best played with 2 to 6 players, though the game works with any number in that range." },
  { question: "What equipment do you need?", answer: "Traditionally, each player needs five six-sided dice and an opaque cup to hide them. Online, you don't need any physical equipment at all." },
  { question: "Is Liar's Dice the same as Dudo?", answer: "Yes, Dudo is the original South American name for the game that English speakers commonly call Liar's Dice. The rules are essentially identical." },
  { question: "What are other names for Liar's Dice?", answer: "Common alternatives include Dudo, Perudo, Bluff, Cachito, and Cacho. Despite the different names, the core mechanics remain consistent." },
  { question: "How does bidding work?", answer: "Each round, a player makes a bid consisting of a quantity and a face value. The next player must either raise the bid or challenge it." },
  { question: "What does \"wild aces\" mean?", answer: "In the standard rules, dice showing a one (aces) count as wild — they match whatever face value is being bid on." },
  { question: "What happens when someone opens bidding on ones?", answer: "Aces are no longer wild for that entire round. This is sometimes called \"breaking aces.\"" },
  { question: "What is a palifico round?", answer: "A palifico round is a special round triggered when a player is reduced to exactly one die. Aces are not wild and players can only raise the quantity." },
  { question: "What is a \"Spot On\" call?", answer: "A Spot On call is when a player declares that the current bid is exactly right. If correct, the caller gains back one lost die. If wrong, the caller loses a die." },
  { question: "Can you gain dice back?", answer: "The only way to gain a die back is by making a successful Spot On (Calza) call." },
  { question: "What happens when you lose all your dice?", answer: "When you lose your last die, you are eliminated from the game. The last player with dice remaining is the winner." },
  { question: "When should I challenge?", answer: "Challenge when you believe the current bid is too high. Each face value appears on roughly one-third of all dice when aces are wild." },
  { question: "How do I calculate probability with wild aces?", answer: "With wild aces, each die has a 2-in-6 (one-third) chance of matching any non-ace face value." },
  { question: "Is bluffing important in Liar's Dice?", answer: "Absolutely. Bluffing is the heart of the game — it's right there in the name." },
  { question: "Is this game free to play?", answer: "Yes, Liar's Dice Online is completely free to play with no paywalls or pay-to-win mechanics." },
  { question: "Can I play on mobile?", answer: "Yes! The game is fully responsive and works on phones, tablets, and desktops." },
  { question: "How does the AI work?", answer: "AI opponents use probability calculations and strategic heuristics, with adjustable difficulty levels." },
  { question: "Do I need to create an account?", answer: "No account is required to play Liar's Dice Online. You can jump straight into a game against AI opponents." },
  { question: "Can I play offline?", answer: "The game requires an internet connection to load initially, but runs entirely in your browser once loaded." },
];
...
const HOW_TO_PLAY_STEPS = [
  ...
  { position: 3, name: "Start Bidding", text: 'The first player makes a bid stating a quantity and a face value, for example "three fives."' },
  { position: 4, name: "Raise the Bid", text: "Each subsequent player must raise the bid by increasing the quantity, the face value, or both — or challenge the previous bid." },
  { position: 5, name: "Understand Wild Aces", text: "Ones (aces) are wild and count as any face value, unless a player opens the round by bidding on ones." },
  { position: 6, name: "Challenge by Calling Liar", text: 'Call "Liar!" to challenge the previous bid. All players reveal their dice and count the relevant face.' },
...
const ROUTES = {
    ...
    jsonLd: [
      {
        ...
        description: "A step-by-step beginner's tutorial for Liar's Dice (also known as Dudo), covering setup, bidding, challenges, wild aces, palifico rounds, and winning the game.",
        totalTime: "PT30M",
  ...
  "sign-in.html": {
    path: "/sign-in",
    title: "Sign in — Liar's Dice",
    description: "Sign in to your Liar's Dice account and get back to the table.",
  },
  "sign-up.html": {
    path: "/sign-up",
    title: "Create account — Liar's Dice",
    description: "Create a free Liar's Dice account and start bluffing your way to victory.",
  },
  "forgot-password.html": {
    path: "/forgot-password",
    title: "Reset password — Liar's Dice",
    description: "Reset the password for your Liar's Dice account.",
  },
};
